    ...
    <table id="scroll-horizontal" class="table nowrap align-middle table-hover table-bordered"  style="width:100%">
                <thead class="table-light">
                    <tr class="text-center">
                        <th>{{ trans('translation.brand_table_picture') }}</th>
                    ...
                    @foreach ($objects as $object)
                        <tr class="text-center">
                            ...
                            <td>
                                    ...
                                    'restoreRoute'=>'brands.restore',
                                    'forceDeleteRoute'=>'brands.forceDelete',
                                    'restorePermission'=>'brand-restore',
                                    'forceDeletePermission'=>'brand-forse-delete',
                                ])
                            </td>
                        </tr>
                    @endforeach
