...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            "phone" => ['bail','nullable','min:10','max:10','regex:'.RegexEnum::PHONE,Rule::unique('clients' ,'phone')->ignore($this)],
            "fax" => ['bail','nullable','min:10','max:10','regex:'.RegexEnum::PHONE,Rule::unique('clients' ,'fax')->ignore($this)],
            "email" => ['bail','nullable','regex:'.RegexEnum::EMAIL,Rule::unique('clients' ,'email')->ignore($this)],
